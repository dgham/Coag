...
class RestApiDoctorController extends AbstractController
{
     ...
     *
     * @Rest\Patch("/api/doctor/UpdateAffiliate/{id}", name ="patch_affiliate")
    ...
    /**
     * @Rest\Get("/api/doctorVerification/{id}", name ="api_verifcation")
     * @Rest\View(serializerGroups={"admin"})
     */
     ...
     * @param Request $request
     *
     * @Rest\Patch("/api/updateAffiliate", name ="patch_doctorr")
     * @Rest\View(serializerGroups={"doctors"})
     */
