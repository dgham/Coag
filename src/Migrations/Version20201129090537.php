 ...
 */
final class Version20201129090537 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD recived_user_id INT DEFAULT NULL, ADD recived_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP recived_user_id, DROP recived_id');
