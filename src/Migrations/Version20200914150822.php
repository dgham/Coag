 ...
 */
final class Version20200914150822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE matricule (id INT AUTO_INCREMENT NOT NULL, doctor_matricule VARCHAR(155) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, removed_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE eatinghabits (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, updated_by_id INT DEFAULT NULL, removed_by_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, removed_at DATETIME DEFAULT NULL, remove TINYINT(1) NOT NULL, breakfast_food VARCHAR(255) DEFAULT NULL, lunch_food VARCHAR(255) DEFAULT NULL, dinner_food VARCHAR(255) DEFAULT NULL, INDEX IDX_CAEFC6E9B03A8386 (created_by_id), INDEX IDX_CAEFC6E9896DBBDE (updated_by_id), INDEX IDX_CAEFC6E92BD701DA (removed_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE foods DROP FOREIGN KEY FK_3803909D896DBBDE');
        $this->addSql('ALTER TABLE foods DROP FOREIGN KEY FK_3803909D2BD701DA');
        ...
        $this->addSql('ALTER TABLE medication_type DROP FOREIGN KEY FK_D70D072AB03A8386');
        $this->addSql('ALTER TABLE medication_type DROP FOREIGN KEY FK_D70D072A896DBBDE');
        $this->addSql('ALTER TABLE medication_type DROP FOREIGN KEY FK_D70D072A2BD701DA');
        ...
        $this->addSql('ALTER TABLE medication_list DROP FOREIGN KEY FK_1F1BA81BB03A8386');
        $this->addSql('ALTER TABLE medication_list DROP FOREIGN KEY FK_1F1BA81B896DBBDE');
        $this->addSql('ALTER TABLE medication_list DROP FOREIGN KEY FK_1F1BA81B2BD701DA');
